...
import { getDeviceSessions, type Session } from '@/lib/iot-api'
...
export function DeviceSessionsTable({ thingName }: DeviceSessionsTableProps) {
  ...
  }, [thingName, desde, hasta, resultado])
