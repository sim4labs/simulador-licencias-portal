...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 grid w-full max-w-3xl max-h-[85vh] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-white p-6 shadow-lg sm:rounded-lg overflow-y-auto',
        className
      )}
      {...props}
    >
...
const DialogHeader = ({ className, ...props }: { className?: string; children?: ReactNode }) => (
