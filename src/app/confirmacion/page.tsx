...
function ConfirmacionContent() {
  ...
  useEffect(() => {
    ...
    // Find tramite by appointment code
    const tramites = getAllTramites()
    const found = tramites.find((t) => t.appointment?.code === code)
    ...
    if (found) {
      ...
      const qrData = JSON.stringify({
        tramiteId: found.id,
        code: found.appointment?.code,
        type: found.licenseType,
        date: found.appointment?.date,
        time: found.appointment?.time,
        name: `${found.personalData.nombre} ${found.personalData.apellidoPaterno}`,
      })
      ...
      {!tramite ? (
        <div className="flex-grow flex items-center justify-center">
          <Card padding="lg" className="text-center">
            ...
            <Link href="/solicitud" className="text-primary-600 hover:underline mt-2 inline-block">
